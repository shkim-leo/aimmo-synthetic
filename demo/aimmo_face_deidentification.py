...
base_path = "/data/noah/inference/ad_face"
...
prompt = "person, pretty, realistic, best quality, extremely detailed, clearness, crystal clear, <lora:add-detail:-1>"
...
for idx, _ in enumerate(os.listdir(base_path)):
    ...
    print(_)
    overlay_image.save(os.path.join(base_path, '{}_out.png'.format(_)))
    sum_mask.save(os.path.join(base_path, '{}_mask.png'.format(_)))