...
from transformers import CLIPTokenizer, CLIPVisionModelWithProjection, CLIPImageProcessor, PretrainedConfig
from transformers.utils import ContextManagers

import diffusers
from diffusers import AutoencoderKL, DDPMScheduler, DDIMScheduler, StableUnCLIPSAGImg2ImgPipeline, UNet2DConditionModel
...
def log_validation(
    ...
    pipeline = StableUnCLIPSAGImg2ImgPipeline.from_pretrained(
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                model_pred = unet(noisy_latents, timesteps, encoder_hidden_states, class_labels=image_embeds).sample
