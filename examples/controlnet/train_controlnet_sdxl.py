...
def prepare_train_dataset(dataset, accelerator):
    ...
    def preprocess_train(examples):
        from PIL import Image
        images = [Image.open(os.path.join(args.train_data_dir,image)).convert("RGB") for image in examples[args.image_column]]
        images = [image_transforms(image) for image in images]

        conditioning_images = [Image.open(os.path.join(args.train_data_dir,image)).convert("RGB") for image in examples[args.conditioning_image_column]]
