...
try:
    ...
    _import_structure["pipeline_dis_controlnet_inpaint"] = ["StableDiffusionDisControlNetInpaintPipeline"]
    ...
    _import_structure["pipeline_controlnet_sd_xl_reference"] = ["StableDiffusionXLControlNetReferencePipeline"]
try:
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_dis_controlnet_inpaint import StableDiffusionDisControlNetInpaintPipeline
        from .pipeline_controlnet_inpaint_sd_xl import StableDiffusionXLControlNetInpaintPipeline
        from .pipeline_controlnet_sd_xl import StableDiffusionXLControlNetPipeline
        from .pipeline_controlnet_sd_xl_img2img import StableDiffusionXLControlNetImg2ImgPipeline
        from .pipeline_controlnet_sd_xl_reference import StableDiffusionXLControlNetReferencePipeline
