...
from diffusers.gmflow.gmflow import GMFlow  # noqa: E402
from diffusers.gmflow.utils.utils import InputPadder  # noqa: E402
...
def get_warped_and_mask(flow_model, image1, image2, image3=None, pixel_consistency=False):
    ...
    if pixel_consistency:
        ...
        bwd_occ = torch.clamp(bwd_occ + (abs(image2 - warped_image1).mean(dim=1) > 255 * 0.25).float(), 0, 1).unsqueeze(
            0
        )
