...
class AnimateDiffControlNetXLPipeline(DiffusionPipeline, TextualInversionLoaderMixin, IPAdapterMixin, LoraLoaderMixin):
    r"""
    ...
    def __call__(
        ...
        **kwargs,
        ...
        if isinstance(conditioning_frames, list):
            original_size = original_size or conditioning_frames[0].shape[-2:]
        else:
            original_size = original_size or conditioning_frames.shape[-2:]
