...
try:
    ...
    _import_structure["pipeline_stable_unclip_sag_img2img"] = ["StableUnCLIPSAGImg2ImgPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_unclip_sag_img2img import StableUnCLIPSAGImg2ImgPipeline
