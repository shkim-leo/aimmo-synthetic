...
class StableUnCLIPSAGImg2ImgPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin):
    """
            ...
            for i, t in enumerate(self.progress_bar(timesteps)):
                ...
                if do_self_attention_guidance:
                    ...
                    if do_classifier_free_guidance:
                        ...
                        uncond_image_embed, _ = image_embeds.chunk(2)
                        # forward and give guidance
                        degraded_pred = self.unet(
                            degraded_latents, t, encoder_hidden_states=uncond_emb, class_labels=uncond_image_embed
                        ).sample
                        ...
                        # forward and give guidance
                        degraded_pred = self.unet(
                            degraded_latents, t, encoder_hidden_states=prompt_embeds, class_labels=image_embeds
                        ).sample
