...
try:
    ...
    _import_structure["rave"] = ["RAVEPipeline", "RAVEPipelineOutput"]
    _import_structure["rerender"] = ["RerenderAVideoPipeline", "TextToVideoSDPipelineOutput"]
    ...
    _import_structure["stable_diffusion"].extend(
        [
            ...
            "StableUnCLIPSAGImg2ImgPipeline",
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .rave import RAVEPipeline, RAVEPipelineOutput
        from .Rerender import RerenderAVideoPipeline, TextToVideoSDPipelineOutput
