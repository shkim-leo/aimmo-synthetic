...
try:
    ...
    _import_structure["pipeline_stable_unclip_xl_img2img"] = ["StableDiffusionXLUnclipImg2ImgPipeline"]
    _import_structure["pipeline_stable_diffusion_xl_reference"] = ["StableDiffusionXLReferencePipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_unclip_xl_img2img import StableDiffusionXLUnclipImg2ImgPipeline
        from .pipeline_stable_diffusion_xl_reference import StableDiffusionXLReferencePipeline
